...
Sixty-three open: twenty-eight on [9router](https://github.com/decolua/9router) (26.3k★), ten on
...
[OmniRoute](https://github.com/diegosouzapw/OmniRoute) (55.2k★), one each on
...
stated rather than tidied away: a red check is worth more to a reader than a claim that
everything is green.
