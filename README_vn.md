...
[odysseus](https://github.com/odysseus-dev/odysseus) (86.9k★), năm trên
[OmniRoute](https://github.com/diegosouzapw/OmniRoute) (62.1k★), và một ở
[OpenClaw](https://github.com/openclaw/openclaw) (389k★). Ở opencodex, Glances và SurfSense tôi
không còn PR nào đang mở. Năm PR ở OmniRoute đều mở trong ngày 07/09; trước đó hai PR khác ở
repo này bị đóng vì trùng với PR người khác mở trước vài tiếng — cùng một bug, cùng một cách sửa,
và cả hai lần phần chẩn đoán đều được xác nhận là đúng trước khi đóng.
